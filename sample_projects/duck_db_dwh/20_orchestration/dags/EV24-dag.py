...
def main():
    ...
    print("Running EV24-dag to download files.")
    # Find project root
...
def download_json_data_to_location(project_root: Path):
    ...
    file_name=f"KNMI_EV24_{end_date}_{start_date}.json"
...
def hash_and_rename_file(file_path: Path) -> Path:
    """ Gemaakt met ai, weet niet precies hoe het werkt, maar doet wat ik wil """
